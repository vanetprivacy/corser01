...
int main(int argc, char *argv[])
{
	...
	int input_type = 2;           // 0=rural, 1=urban, 2=city
    ...
    cout << "smz rural " << radius << " " << zone_qty << setprecision(5) 
        << fixed << " " << avg_k << " " << avg_d << " " << avg_t 
        << " " << anoncount << " " << maxv << endl;
    if (input_type == 1) // urban
        cout << "smz urban " << radius << " " << zone_qty << setprecision(5) 
        << fixed << " " << avg_k << " " << avg_d << " " << avg_t 
        << " " << anoncount << " " << maxv << endl;
    if (input_type == 2) // city
        cout << "smz city " << radius << " " << zone_qty << setprecision(5) 
        << fixed << " " << avg_k << " " << avg_d << " " << avg_t 
        << " " << anoncount << " " << maxv << endl;
