...
int main(int argc, char *argv[])
{
    ...
    // For OTFP-R: Total Overhead = Announcement Overhead + Join Req + Join Confirmation
    ...
    // For OTFP-R: Total Overhead = Announcement Overhead + Join Req + Join Confirmation
    TotalOverheadCounter = AnnouncementOverhead + JoinReqOverhead + JoinConfirmOverhead;
